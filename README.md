...
| Direct a visible change    | Send a short instruction or use the four live cues. The UI distinguishes sending, provider acceptance, and the next received chunk.                                                                        |
